...
Como Usar
Certifique-se de ter uma conta no Telegram.
Procure pelo bot @AlcateiaCSBot (ou o nome que você definir para o seu bot) no Telegram e inicie uma conversa.
Você pode interagir com o bot das seguintes maneiras:
...
Após receber uma informação, responda com s ou sim se quiser saber mais alguma coisa.
Pré-requisitos
...
Configuração
Obtenha um Token do Bot do Telegram:
...
Salve o código em um arquivo chamado AlcateiaCSBot.py.
